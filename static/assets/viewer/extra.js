...
var viewer = {
    ...
    check_parameters: function () {
        ...
        this.extraSeq = 'extraseq' in queryParams ? queryParams.extraseq : undefined;
    ...
    ready: function (_cb) {
        ...
        this.check_parameters()
            ...
            .then(function () {
                ...
                var params = {
                    extraSeq: self.extraSeq
                };
                return tms.get_extra_info(params);
            })
            .then(function (data) {
                console.log(data);
                $.LoadingOverlay("hide");
    ...
    set_info: function (data, _cb) {
        ...
        if (this.update_document_title) {
            top.document.title = this.info.title;
        }
    ...
    select_index_func: function (index) {
        ...
        if (this.page.type == 'pdf') {
            ...
            Module.pdf_viewer.drow_pdf('module-body', get_url(this.page.file), this.page.page);
            try {
            ...
            if (this.page.type == 'video' || this.page.type == 'audio' || this.page.type == 'youtube') {
                ...
                if (self.file_type == 'audio') {
                    mime_type = 'audio/mp3';
                } else if (self.file_type == 'youtube') {
