...
$(document).on("click", "#download", function () {
    ...
    $("#mteacher-button").on('click', function() {
        let domain = "https://e.m-teacher.co.kr/";
        if(window.opener){
            let parentUrl = window.opener.document.URL;
            if(parentUrl.indexOf('m.m-teacher.co.kr') > -1){
                domain = "https://m.m-teacher.co.kr/";
            }else if(parentUrl.indexOf('h.m-teacher.co.kr') > -1){
                domain = "https://h.m-teacher.co.kr/";
            }
        }
