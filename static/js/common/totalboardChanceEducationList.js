$(function (){
  let screen = {
        ...
        const options = {
          ...
          success: function (res){
            if(type === 'likeBtn'){
              ...
              if(scrapYn === 'Y'){
                $toast.open(`toast-scrap-${masterSeq}`, 'MG00041');
              }else{
                $toast.open(`toast-scrap-${masterSeq}`, 'MG00042');
              }
            }
          }
        };
            ...
            <div class="inner-wrap">
              ...
              <div class="board-buttons board-list">
                ...
                <div class="buttons">
                  ...
                  <button type="button" name="shareBtn" class="button type-icon size-sm" th:data-viewyn="Y" th:data-path="${data.pageLink}">
                    <svg>
                      <title>공유하기</title>
      ...
      */
      ...
      bindDataList: () => {
        ...
        screen.v.eventList.map((eventItem, eventItemIdx) => {
          ...
          screen.v.resultList.map((data, totalboardItemIdx) => {
            if(data['categoryGroupName1'] === 'EVENT' && data['categoryGroupName7'] === eventItem.id){
              const htmlItem2 = screen.f.getBoardItem(data);
    ...
    init: function (){
      console.log("totalboardChanceEducationList init");
