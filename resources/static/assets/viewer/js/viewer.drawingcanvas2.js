    ...
    DrawingCanvas.prototype = {
        ...
        _setTransformer: function DrawingCanvas_setTransformer(e) {
            ...
            if (this.mode == 'text' && e.target.attrs.name == 'textNodes') {
                ...
                _transformer = new Konva.Transformer({
                    ...
                    boundBoxFunc: function (oldBox, newBox) {
                        // var max_width = (e.target.parent.parent.attrs.width - newBox.x) * 0.9;
                        // if (Math.abs(newBox.width) < 100 || Math.abs(newBox.width) > max_width) {
                        if (Math.abs(newBox.width) <= 100 || Math.abs(newBox.width) >= 500) {
                            if (Math.abs(newBox.width) <= 100) {
                                _transformer.stopTransform();
            ...
            if (!_deletebutton) {
                ...
                if (CURRICULUM_CODE === 'AUTH') {
                    ...
                    deleteicon.src = 'img/viewer/mathtool_delete.png';
                ...
                if (this.mode == 'text') {
                    ...
                    _transformer.on('transform', function () {
                        ...
                        } else if (e.target.attrs.name == 'protractor') {
                            _deletebutton.x(-44);
                            _deletebutton.y(_transformer.getHeight() + 8);
                    ...
                    _transformer.on('transformend', function () {
                        ...
                        // 자
                        if (e.target.attrs.name == 'ruler') {
                            _transformer.find('.middle-right')[0].setAttrs({
                                'x': _transformer.find('.middle-right')[0].attrs.x + 17,
                                'y': _transformer.find('.middle-right')[0].attrs.y + 2
                            });
                        ...
                        // 각도기, 삼각자
                        if (e.target.attrs.name == 'protractor') {
                            // _transformer.find('.top-left')[0].setAttrs({
                            //     'x': _transformer.find('.top-left')[0].attrs.x - 15,
                            //     'y': _transformer.find('.top-left')[0].attrs.y - 15
                            // });

                            // _transformer.find('.rotater')[0].setAttrs({
                            //     'y': -26,
                            // });
                            ...
                            // 삼각자 회전 버튼
                            // _transformer.find('.rotater')[0].setAttrs({
                            //     'y': _transformer.getHeight() + 30,
                            //     // 'y': -26,
                            //     'x': _transformer.getWidth() + 30
                            // });

                            // 아이콘 - 회전축 모두 좌측 하단 모서리
                            // _transformer.find('.rotater')[0].setAttrs({
                            //     'y': -26,
                            //     'x': _transformer.getWidth() + 30
                            // });
                    ...
                    if (e.target.attrs.name == 'ruler') {
                        ...
                        // 각도기 회전 버튼
                        // _transformer.find('.rotater')[0].setAttrs({ 'y': -26 });
                ...
                if (CURRICULUM_CODE === 'AUTH' && this.mode == 'mathTool') {
                    ...
                    if (!_zoombutton) {
                        ...
                        if (this.mode == 'mathTool' && (e.target.attrs.name == "setSquare" || e.target.attrs.name == "protractor")) {
                            ...
                            zoomicon.src = 'img/viewer/mathtool_zoom.png';

                            if (e.target.attrs.name == "setSquare") {
                                _zoombutton.x(-44);
                                _zoombutton.y(-44);

                                _transformer.findOne('.top-left').strokeEnabled(false);
                            ...
                            zoomicon.src = 'img/viewer/mathtool_ruler_zoom.png';
                    ...
                    if (!_rotatebutton) {
                        if (this.mode == 'mathTool' && (e.target.attrs.name == "setSquare" || e.target.attrs.name == "protractor" || e.target.attrs.name == 'ruler')) {
                            ...
                            rotateicon.onload = function () {
                                ...
                                if (e.target.attrs.name == "setSquare") {
                                    // _rotatebutton.x(_transformer.getWidth() + 10);
                                    // _rotatebutton.y(_transformer.getHeight() + 10);
                                    // _rotatebutton.y(-45);
                                    ...
                                    // _rotatebutton.x((_transformer.getWidth() / 2) - 16);
                            ...
                            rotateicon.src = 'img/viewer/mathtool_rotate.png';
        ...
        create_set_square: function () {
            ...
            imageObj.onload = function () {
                ...
                // imageNode_set_square.rotate(180);
                self.mathToolLayer.draw();
        ...
        create_protractor: function () {
            ...
            imageObj.onload = function () {
                ...
                // imageNode_protractor.rotate(180);
