...
'use strict';
		...
		return this.each( function() {
			...
			base.findCaretPos = function() {
				...
				if( style.textAlign === 'right' ){
					style.width = parseInt( isInput ? element.scrollWidth : computed.width, 10 ) + 'px';
				}else{
				...
				// console.log("caret isInput", isInput);
				// console.log("caret element.scrollWidth", element.scrollWidth);
				// console.log("caret computed.width", computed.width);
				// console.log("caret fontWidth", fontWidth);
				// console.log("caret style.width ", style.width );
				...
				// console.log("caret offset.left", offset.left)
	// 			console.log("caret computed.borderLeftWidth", parseInt( computed.borderLeftWidth, 10 ))
	// 			console.log("caret o.offsetX", o.offsetX)
	// 			console.log("caret pos", pos)
				...
				//세로 offset
				var posY = style / 40;
				// console.log("caret posY 1", style);
				// console.log("caret posY 2", posY);
				
				var top = offset.top - element.scrollTop + base.caretPos.top - margin + posY;
				if( top < 0 ) top = 5;
