...
const CMS_API = "https://api-cms.mirae-n.com/view_content?service=";
const CMS_SERVICE = "mteacher"
...
function get_cms_url(uploadMethod, url) {

    let returnUrl = null;

    if (uploadMethod == "CMS") {
        returnUrl = CMS_API + CMS_SERVICE + "&params=" + url;
    }

    // console.log("get_cms_url >> "+returnUrl);
