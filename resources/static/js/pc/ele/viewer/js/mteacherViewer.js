let mteacherViewer = {
        ...
        return new Promise(function (resolve, reject) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.download_yn != 'Y') $('#download').addClass('display-hide');
                },
    ...
    get_cms_file_info: function (content_seq) {
        return new Promise(function (resolve, reject) {
            if (!content_seq) {
                reject(
                    vex.dialog.confirm({
            ...
            $.ajax({
                method: "GET",
                url: '/pages/api/preview/previewCmsItem.ax',
                data: { contentSeq: content_seq },
                success: function (data) {
                    console.log(data);
                    resolve(data);
                ...
                error: function (error) {
                    ...
                    console.log("get_cms_file_info error : " + error)
                }
            })
        });
    },
